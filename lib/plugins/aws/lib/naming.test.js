...
describe('#naming()', () => {
  ...
  describe('#getWebsocketsRouteModelLogicalId()', () => {
    it('should return the Websockets route model logical id', () => {
      expect(sdk.naming.getWebsocketsRouteModelLogicalId('message')).to.equal(
